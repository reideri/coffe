...
<div class="form">
  ...
  <form class="login-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <div class="container">
      <div class="success">
        Gracias por enviar tu solicitud, nuestros asesores revisarán su informacion y se enviará un correo electronico
        con un mensaje de confirmación o denegado.
      </div>
    </div>
  </form>
</div>
