        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="notas.php" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Notas</a>
                    </li>
                    <li>
                        <a href="monedero.php" class="waves-effect"><i class="fa fa-money fa-fw" aria-hidden="true"></i>Monedero</a>
                    </li>
                    <li>
