                        ...
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo $post['titulo']; ?></h3>
                                ...
                                <div class="panel-body">
                                    <div class="thumb" style="width: 100%; height: auto; max-height: 400px; overflow: hidden;">
                                      <img src="<?php echo RUTA.'img/post/'.$post['thumb']; ?>" alt="" class="img-responsive">
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                      <div class="col-md-3">
                                        ...
                                        <a href="<?php echo 'borrar.php?id='.$post['id']; ?>" class="btn btn-primary btn-lg" id="share">
                                            Borrar Post
                                        </a>
                                      </div>
                                    </div>
